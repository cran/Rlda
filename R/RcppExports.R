...
lda_multinomial <- function(data, n_community, beta, gamma, n_gibbs, ll_prior = TRUE, display_progress = TRUE) {
    .Call('_Rlda_lda_multinomial', PACKAGE = 'Rlda', data, n_community, beta, gamma, n_gibbs, ll_prior, display_progress)
}
...
getks <- function(z, ncommun, dat) {
    .Call('_Rlda_getks', PACKAGE = 'Rlda', z, ncommun, dat)
}
...
getlk <- function(z, locid, ncommun, nloc) {
    .Call('_Rlda_getlk', PACKAGE = 'Rlda', z, locid, ncommun, nloc)
}

#' This function samples z's
samplez <- function(ltheta, l1minustheta, lphi, dat1, locid, randu, ncommun, nloc) {
    .Call('_Rlda_samplez', PACKAGE = 'Rlda', ltheta, l1minustheta, lphi, dat1, locid, randu, ncommun, nloc)
}

#' This function converts vmat into theta
convertVtoTheta <- function(vmat, prod) {
    .Call('_Rlda_convertVtoTheta', PACKAGE = 'Rlda', vmat, prod)
}
...
lda_binomial <- function(data, pop, n_community, alpha0, alpha1, gamma, n_gibbs, ll_prior = TRUE, display_progress = TRUE) {
    .Call('_Rlda_lda_binomial', PACKAGE = 'Rlda', data, pop, n_community, alpha0, alpha1, gamma, n_gibbs, ll_prior, display_progress)
}

lda_binomial_var <- function(data, n_community, maxit, n_obs, gamma, a_phi, b_phi, thresh, delta_elbo, m1, m0) {
    .Call('_Rlda_lda_binomial_var', PACKAGE = 'Rlda', data, n_community, maxit, n_obs, gamma, a_phi, b_phi, thresh, delta_elbo, m1, m0)
}
...
lda_bernoulli <- function(data, n_community, alpha0, alpha1, gamma, n_gibbs, ll_prior = TRUE, display_progress = TRUE) {
    .Call('_Rlda_lda_bernoulli', PACKAGE = 'Rlda', data, n_community, alpha0, alpha1, gamma, n_gibbs, ll_prior, display_progress)
}
...
convertSBtoNormal <- function(vmat, ncol, nrow, prod) {
    .Call('_Rlda_convertSBtoNormal', PACKAGE = 'Rlda', vmat, ncol, nrow, prod)
}

aggregatesum <- function(Tobesum, nind, nobs, ind) {
    .Call('_Rlda_aggregatesum', PACKAGE = 'Rlda', Tobesum, nind, nobs, ind)
}
